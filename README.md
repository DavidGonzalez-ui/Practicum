...
Antes de empezar se debe de copiar el PDF a procesar y los scripts a una misma carpeta
...
En caso de que se vuelva a procesar el mismo PDF, el script no duplica el
